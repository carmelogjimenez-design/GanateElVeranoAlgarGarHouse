...
export async function loadAll(): Promise<DB> {
  const tables = [
    ...
    "redemptions", "gifts", "subjects", "study_sessions", "point_events", "task_targets", "badges_catalog", "kid_badges", "study_rewards", "study_questions_seen", "test_sessions", "events", "activity_reactions", "milo_walks", "notifications", "market_offers",
  ] as const;
